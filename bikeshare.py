...
def get_filters():
    ...
    while True:
      month = input("\nWhich month would you like? January, February, March, April, May, June or type 'all' ?\n").title()
    ...
    while True:
      day = input("\nAre you looking for a particular day? Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday or type 'all' \n").title()
    ...
    while True:
        ...
        while(flag ==1):
            ...
            while((flag != 1) and (flag!=2)):
                flag=int(input('\nPlease enter available input: 1 or 2 '))
